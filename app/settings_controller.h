...
class SettingsController final : public QObject {
    ...
    Q_PROPERTY(QString debuggerBackend READ debuggerBackend WRITE setDebuggerBackend NOTIFY changed)
...
public:
    ...
    QString debuggerBackend() const { return debuggerBackend_; }
    ...
    void setDebuggerBackend(const QString& value);
...
private:
    ...
    QString debuggerBackend_ = QStringLiteral("windows");
